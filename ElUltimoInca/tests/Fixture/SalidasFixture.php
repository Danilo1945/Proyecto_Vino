...
class SalidasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'egreso_sal' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'donacion_sal' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        'devolucion_sal' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
    ...
    public $records = [
        [
            ...
            'devolucion_sal' => 1,
            'saldo_total' => 1,
            'observaciones_sal' => 'Lorem ipsum dolor sit amet'
        ],
    ];
}
