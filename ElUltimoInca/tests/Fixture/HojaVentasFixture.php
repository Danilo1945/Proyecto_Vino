 ...
 *
 */
class HojaVentasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'estado_venta' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        'valor_estado' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'hoja_ventas_ibfk_1' => ['type' => 'foreign', 'columns' => ['trabajador_id'], 'references' => ['trabajador', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'hoja_ventas_ibfk_2' => ['type' => 'foreign', 'columns' => ['users_id'], 'references' => ['users', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'precio_unitario' => 1,
            'precio_total' => 1,
            'estado_venta' => 'Lorem ipsum dolor ',
            'valor_estado' => 1,
