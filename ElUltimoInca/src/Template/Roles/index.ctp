...
<div class="container" id="roles_index">
    <?= $this->Html->button(
        '<i class="fa fa-plus-circle fa-lg"></i> ' . __('New Role'),
        ['action' => 'add'],
    ...
    <div class="table-responsive">
        <table class="table table-striped table-hover">
            ...
            <tr>
                ...
                <td class="text-right">
                    <?= $this->Html->link(null, ['action' => 'view', $role->id], ['class' => 'btn btn-primary fa fa-eye p-1 mx-1']) ?>
                            <?= $this->Html->link(null, ['action' => 'edit', $role->id], ['class' => 'btn btn-primary fa fa-pencil p-1 mx-1']) ?>
                            <?= $this->Form->postLink(null, ['action' => 'delete', $role->id], [
