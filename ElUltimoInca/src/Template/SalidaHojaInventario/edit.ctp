            ...
            <div class="card-content white-text">
                ...
                <div class="card-action">
                    <li class="padding-action"><?= $this->Form->postLink(
                            __('Delete'),
                            ['action' => 'delete', $salidaHojaInventario->id],
                            ['confirm' => __('Are you sure you want to delete # {0}?', $salidaHojaInventario->id)]
                            )
                            ?></li>
    ...
    <div class="col s12 m9">
        <div class="card darken-1">
            <div class="card-content black-text">
                ...
                <span class="card-title green-text"><?= __('Edit Salida Hoja Inventario') ?></span>
