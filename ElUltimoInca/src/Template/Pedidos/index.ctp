    ...
    <div class="col s12 m9">
        <div class="card darken-1">
            <div class="card-content black-text">
                <span class="card-title green-text"><?= __('Pedidos') ?></span>
                <table class="responsive-table">
                    ...
                    <?php foreach ($pedidos as $pedido): ?>
                        <tr>
                            ...
                            <td><?= $pedido->has('trabajador') ? $this->Html->link($pedido->trabajador->id, ['controller' => 'Trabajador', 'action' => 'view', $pedido->trabajador->id]) : '' ?></td>
                            ...
                            <td><?= $this->Number->format($pedido->precio_uni) ?></td>
                            <td><?= $this->Number->format($pedido->precio_total) ?></td>
